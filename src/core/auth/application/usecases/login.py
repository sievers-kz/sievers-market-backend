...
class LoginUserUseCase:
    ...
    async def execute(self, login_data: LoginUserDTO):
        async with self.unit_of_work as uow:
            ...
            hashed_password = identity.credentials.hashed_password.hashed_password

            password_is_match = self.password_hasher.verify_password(login_data.raw_password, hashed_password)
