...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "media_type",
            sa.Enum("PNG", "JPEG", "WEBP", name="mediatype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "status", sa.Enum("ACTIVE", "DELETED", name="catalogstatus"), nullable=False
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "avatar_url", sa.Text(), server_default="default_avatar.png", nullable=True
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("REFRESH", "ACCESS", "EMAIL", "PASSWORD", name="tokentype"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "legal_form",
            sa.Enum("IE", "LLP", "JSC", "FARM", name="legalform"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "CLOSED", "BANNED", name="vendorstatus"),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "currency",
            sa.Enum("KZT", "RUB", "USD", "EUR", name="pricecurrency"),
            nullable=True,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("ACTIVE", "INACTIVE", "ARCHIVED", "DELETED", name="listingstatus"),
            nullable=True,
        ),
        sa.Column("id", sa.UUID(), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["subcategory_id"], ["subcategories.id"], ondelete="RESTRICT"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
