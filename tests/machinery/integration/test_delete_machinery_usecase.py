...
class TestDeleteMachineryUsecase:
    @pytest.mark.asyncio
    @pytest.mark.integration
    async def test_delete_machinery_successful(
        self,
        create_machinery_usecase,
        delete_machinery_usecase,
        ...
        await delete_machinery_usecase.execute(create_customer.id, machinery_id)
